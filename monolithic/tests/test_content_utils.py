...
@pytest.mark.parametrize(
    ...
    [
        (
            "ccx_rules_ocp.external.rules.some_rule.report",
            "ccx_rules_ocp.external.rules.some_rule",
        ),
        (
            "ccx_rules_ocp.external.rules.some_rule.check",
            "ccx_rules_ocp.external.rules.some_rule",
        ),
        (
            "ccx_rules_ocp.external.report.some_rule.report",
            "ccx_rules_ocp.external.report.some_rule",
        ),
        ("", ""),
    ],
)
